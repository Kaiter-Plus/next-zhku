<script>
  import TabBar from 'components/common/tabs/TabBar.vue';
  ...
  export default {
    ...
    render(h) {
      ...
      const scrollBtn = scrollable
        ? [
          <span class={['tabs__nav-prev', scrollable.prev ? '' : 'is-disabled']} on-click={scrollPrev}><i class="iconfont icon-zuo"></i></span>,
          <span class={['tabs__nav-next', scrollable.next ? '' : 'is-disabled']} on-click={scrollNext}><i class="iconfont icon-you"></i></span>
        ] : null;
      ...
      const tabs = this._l(panes, (pane, index) => {
        ...
        const btnClose = closable
          ? <span class="iconfont icon-cuowu" on-click={(ev) => { onTabRemove(pane, ev); }}></span>
          : null;
      ...
      return (
        <div class={['tabs__nav-wrap', scrollable ? 'is-scrollable' : '', `is-${this.rootTabs.tabPosition}`]}>
          {scrollBtn}
          <div class={['tabs__nav-scroll']} ref="navScroll">
            <div
              class={['tabs__nav', `is-${this.rootTabs.tabPosition}`, stretch && ['top', 'bottom'].indexOf(this.rootTabs.tabPosition) !== -1 ? 'is-stretch' : '']}
              ref="nav"
              style={navStyle}
              role="tablist"
